...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'player', 'court-owner', 'team-member'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Matches', path: '/matches', entity: 'match', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    { name: 'Rankings', path: '/rankings', entity: 'ranking', service: AccessServiceEnum.PROJECT, icon: FiStar },
