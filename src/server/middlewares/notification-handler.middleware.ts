...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'match.create': {
    roles: ['administrator', 'player', 'court-owner', 'team-member'],
    key: 'new-match-scheduled',
  ...
  'court.update': {
    roles: ['administrator', 'player'],
    key: 'court-availability-changed',
...
const tenantRoles: string[] = ['administrator', 'player', 'court-owner', 'team-member'];
