  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to JogaJunto - your hub for scheduling football matches. Create affinity groups, join matches, and follow other users, all within a 10km radius. Unleash your passion for football, and let your fair play, playability, punctuality, and availability be your ranking."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to JogaJunto - your hub for scheduling football matches. Create affinity groups, join matches, and follow other users, all within a 10km radius. Unleash your passion for football, and let your fair play, playability, punctuality, and availability be your ranking.`}
            </Text>
            <Box
